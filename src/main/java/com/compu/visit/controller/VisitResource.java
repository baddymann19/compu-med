...
public class VisitResource {
    ...
    @POST
    public Uni<RestResponse<VisitDTO>> createVisit(VisitRequestDTO requestDTO) {
    ...
    @PUT
    @Path("/{id}")
    public Uni<RestResponse<VisitDTO>> updateVisit(@PathParam("id") Long id, VisitRequestDTO requestDTO) {
